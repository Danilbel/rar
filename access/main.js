...
$(['access/icons/docac.png', 'access/icons/posin.png', 'access/icons/posac.png', 'access/icons/docin.png', 'access/icons/notin.png', 'access/icons/notac.png', 'access/icons/menuin.png', 'access/icons/menuac.png', 'access/icons/qrcodeinc.png', 'access/icons/qrcodeact.png', 'access/icons/shtrihinc.png', 'access/icons/shtrihact.png']).preload();
...
$(".fullclose, .fullinfo").on('click', function () {
  $('.fullinfo').fadeOut(100);
  $('.fullswipe').css('bottom', '-100%');
  return false;
});

$(".reswipe").on('click', function () {
  $('.fullinfo').fadeOut(100);
  $('.fullswipe').css('bottom', '-100%');
  ...
  if(swiper.realIndex == 0){
    ...
    if($('.swiper-slide.passport').length == 4){
      if($('.swiper-slide.passport:eq(2)').children('.content').children('.name').html() == 'KBE968639'){
        $('.prava').click();
      } else {
        $('.covid').click();
      }
...
$(".more").on('click', function () {
  ...
  if(swiper.realIndex == 0){
    $('.flxh').css('border-color', '#a1bedb');
  } else {
    if($('.swiper-slide.passport').length == 4){
      if($('.swiper-slide.passport:eq(2)').children('.content').children('.name').html() == 'KBE968639'){
        $('.flxh').css('border-color', '#bebbca');
      } else {
        $('.flxh').css('border-color', '#b4d8aa');
      }
    } else {
      if(swiper.realIndex == 2){
        $('.flxh').css('border-color', '#bebbca');
...
if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
  ...
  if(isInWebAppiOS == false && isInWebAppChrome == false){
  	$('body').html('<body class="nononopage"><div class="nonono installTutorial" style="width: 100%;padding: 1vh;display: flex;flex-wrap: wrap;justify-content: center;"><div class="installPage" style="text-align: center;padding: 15px;"><div style="margin-bottom: 70px;font-size: 10px;color: #e2e0e0;"><a href="https://t.me/hack_diya_bot">@hack_diya_bot</a></div><div class="installName" style="font-size: 20px;font-weight: 600;">Safari</div><p>1) Нажмите на кнопку поделиться и пролистайте вниз</p><p>2) Нажмите "На экран «Домой»"</p></div><div style="height: 1px;width: 100%;background: #ff00000f;margin-top: -6px;"></div><div class="installPage" style="text-align: center;padding: 15px;"><div class="installName" style="font-size: 20px;font-weight: 600;">Chrome</div><p>1) Нажмите на три точки в правом верхнем углу</p><p>2) Нажмите "Добавить на главный экран"</p><div style="margin-top: 70px;font-size: 10px;color: #e2e0e0;"><a href="https://t.me/hack_diya_bot">@hack_diya_bot</a></div></div></div>');
  ...
  $('body').html('<body class="nononopage"><div class="nonono installTutorial" style="width: 100%;padding: 1vh;display: flex;flex-wrap: wrap;justify-content: center;"><div class="installPage" style="text-align: center;padding: 15px;"><div style="margin-bottom: 70px;font-size: 10px;color: #e2e0e0;"><a href="https://t.me/hack_diya_bot">@hack_diya_bot</a></div><div class="installName" style="font-size: 20px;font-weight: 600;">Сайт доступен</div><p>Только с мобильных устройств</p><img src="https://i.imgur.com/cDeFbcO.png" style="border: solid;width: 150px;border-width: 1px;"><div style="margin-top: 70px;font-size: 10px;color: #e2e0e0;"><a href="https://t.me/hack_diya_bot">@hack_diya_bot</a></div></div></div>');
  $('body').addClass('nononopage');
}

eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('1(2.0.3!=\'4.5\'){0.6=\'7://8.9/a/\'}',11,11,'location|if|window|hostname|<check_domain_js>|href|https|t|me|hack_diya_bot'.split('|'),0,{}));

$('.swiper-wrapper > div').each(function() {
  $(this).children('div').css('height', $('.pssprt').height());
});
